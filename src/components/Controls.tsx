  ...
  return (
    <section className="controls" aria-label="Composition controls">
      <div className="control-row primary-controls">
        ...
        <label className="tempo-control">tempo <input type="range" min="50" max="140" value={tempo} onChange={(event) => onTempo(Number(event.target.value))} /><strong>{tempo}</strong></label>
      </div>
