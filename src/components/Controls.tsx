  ...
  return (
    <section className="controls" aria-label="Composition controls">
      <div className="control-row primary-controls">
        ...
        <button className={`round-button eraser-button ${eraserMode ? 'active' : ''}`} onClick={onEraser} aria-label={eraserMode ? 'Exit eraser mode' : 'Erase a complete stroke'} aria-pressed={eraserMode}>⌫</button>
